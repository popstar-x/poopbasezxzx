  ...
  return (
    <div className="onboarding-wrapper">
      ...
      <div className="guide-wrapper">
        <Step step="Create an account" number={1}/>
        <div className="bar" />
        <Step step="Link your bank account" number={2}/>
        <div className="bar" />
        <Step step="Start buying & selling" number={3}/>
      </div>
      <style jsx>
        {`
          .onboarding-wrapper {
          ...
          .bar {
            ...
            height: 1px;
            margin-top: 40px;
            background-color: rgb(91, 97, 110, 0.66);
          }
        `}
      </style>
    </div>
...
const Step = ({ step, number }) => {
  return (
    <div className="step-wrapper">
      {number === 1 ? <AddIcon /> : number === 2 ? <BankIcon /> : <TradeIcon /> }
...
function AddIcon(props) {
  return (
    <svg width={64} height={60} viewBox="0 0 64 60" fill="none" {...props}>
      <path
        d="M32 16a8 8 0 100-16 8 8 0 000 16zm0 4c-11.05 0-20 7.16-20 16v18h40V36c0-8.84-8.95-16-20-16z"
        fill="#56B4FC"
      />
      <path d="M64 36H0v24h64V36z" fill="#BFE9FF" />
      <path d="M52 36H12v24h40V36z" fill="#1652F0" />
      <path d="M33 42h-2v12h2V42z" fill="#fff" />
      <path d="M38 49v-2H26v2h12z" fill="#fff" />
    </svg>
  )
}
...
function BankIcon(props) {
  return (
    <svg width={65} height={56} viewBox="0 0 65 56" fill="none" {...props}>
      <path d="M57.03 20h-50v24h50V20z" fill="#BFE9FF" />
      <path
        ...
        fill="#56B4FC"
      />
      <path d="M52.03 20h-40v24h40V20z" fill="#1652F0" />
      <path
...
function TradeIcon(props) {
  return (
    <svg width={61} height={56} viewBox="0 0 61 56" fill="none" {...props}>
      <path
        ...
        fill="#56B4FC"
      />
      <path d="M16 36H0v20h16V36z" fill="#BFE9FF" />
      <path d="M16 40H0v12h16V40z" fill="#1652F0" />
      <path
      ...
      />
      <path
        d="M32 9h-3V6h-2v3h-3v2h3v3h2v-3h3V9zm20 18v-2h-8v2h8z"
        fill="#fff"
      />
    </svg>
  )
